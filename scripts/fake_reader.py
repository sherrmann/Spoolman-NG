...
# ruff: noqa: ANN401, D102, D103, D107, PLR2004, S311, T201  (this is a CLI script: print is
# the point, dynamically-typed JSON in/out is inherent to a thin HTTP client, and the fake
# UID generator has no need of a cryptographic RNG)
