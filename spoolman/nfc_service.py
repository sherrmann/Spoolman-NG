...
class NfcService:
    ...
    def read_tag(self, timeout: float = 10.0) -> bytes | None:
    ...
    def read_tag_auto(self, timeout: float = 10.0) -> TagReadResult | None:
    ...
    def _read_mifare_classic_block(self, tag: "nfc.tag.Tag", uid: bytes) -> bytes | None:
        ...
        """
        from spoolman.qidi_codec import QIDI_ABSOLUTE_BLOCK, QIDI_KEYS
