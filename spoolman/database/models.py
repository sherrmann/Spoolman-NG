...
class Filament(Base):
    ...
    # selectin like Spool.tags. Every response carrying a filament carries its tags, a spool
    # listing included since each spool embeds its filament, so this is one extra
