// Ported from the classic client's client/src/utils/swatch/threeMf.test.ts (#415 step 3).
...
import { assertWatertight, meshBounds, meshVolume } from './meshHelpers';
...
import type { XmlDocument, XmlElement } from './xmlTestHelpers';
...
function parseModel(data: Uint8Array): XmlDocument {
 ...
 */
function meshPartsFromObjectElement(object: XmlElement): { base: Mesh; marking: Mesh } {
...
function meshObject(doc: XmlDocument): XmlElement {
