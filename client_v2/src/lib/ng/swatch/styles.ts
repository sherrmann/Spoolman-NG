// Ported from the classic client's client/src/utils/swatch/styles.ts (#415 step 3).
...
import { buildSwatchLayout, idWeightText, materialDiameterText, temperaturesText } from './layout';
import type { SwatchInput, SwatchLayout, SwatchStyleSpec } from './layout';
