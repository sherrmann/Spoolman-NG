// Ported from the classic client's client/src/test/meshHelpers.ts (#415 step 3).
// Moved alongside the swatch module (instead of a shared client_v2 test-utils
// location) because this port is confined to src/lib/ng/swatch/.
