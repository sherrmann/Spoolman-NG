 ...
 * with the name, material and stock aggregates below, for browsing the catalog by colour.
 * Clicking opens the filament. Read-only — edits happen in the table/detail.
 */
